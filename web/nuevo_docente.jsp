            ...
            <center>
                <form action="servlet_registrar">
                    <table border = 1px>
                        ...
                        <tr>
                            <th>ESPECIALIDAD : </th>
                            <td><input type="text" name="txtespecialidad" placeholder="ingrese su especialidad" required/></td>
                        </tr>
                        <tr>
                            <th colspan="2"><input type="submit" name="btnregistrar" value="GUARDAR DATOS DEL DOCENTE"/></th>
                        </tr>
                    </table>
                    <br/>
                    <br/>
